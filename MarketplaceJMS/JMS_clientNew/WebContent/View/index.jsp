		...
		<%}%> --%>
         ...
         <ul class="categories">
			...
			// retrieve your list from the request, with casting 
				if(request.getSession().getAttribute("cataloglist") != null){
					Catalog[] list =  (Catalog[]) request.getSession().getAttribute("cataloglist");
					// print the information about every category of the list
					for(int i =0;i<list.length;i++) {%>
						
					    <li>
						    <span>
						    	<a  href="/JMS_clientNew/View/GetProducts?catid=<%= list[i].getCatid() %>"> <%= list[i].getCatname() %> </a>
						   </span>
					    </li>
					<%}
					...
					for(int i =0;i<prolist.length;i++) {%>
					    ...
					    <li class="table" ><span></span>
                                       ...
                                       <table>
                                          ...
                                          <tr>
                                             <td>
                                                <h5>Seller : <%= prolist[i].getSellerinfo() %></h5>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td>
                                                <button class="add_to_cart" id="<%= prolist[i].getProid()%>">Add to cart</button>
